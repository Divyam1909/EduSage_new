    ...
    import { BookOpen, Home, Menu, MessageSquare, PenTool, Play, HelpCircle, BookOpenCheck, Users, FileText, PuzzleIcon as Quiz, User, Bookmark, Calendar, Bot } from 'lucide-react'
          ...
          <div className="flex-1 flex flex-col">
            ...
            <div className="flex-1 p-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <div className="flex flex-col bg-white rounded-lg shadow-md overflow-hidden">
                ...
                <div className="p-4 flex-1 flex flex-col justify-between">
                  <p className="text-purple-800">
                    Get instant assistance from our AI tutor. Ask questions, clarify concepts, and deepen your understanding of complex topics.
                  </p>
                  <Button 
                    className="mt-4 bg-purple-500 hover:bg-purple-600 text-white"
                    onClick={() => window.location.href = "/ai"}  // Redirects to AI Assistant page
                  >
